...
WHERE C.value_as_concept_id in (45884084,45878583)
...
;
DELETE FROM results.pnhs_vr where cohort_definition_id = 1;
INSERT INTO results.pnhs_vr (cohort_definition_id, subject_id, cohort_start_date, cohort_end_date)
