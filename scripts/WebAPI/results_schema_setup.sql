-- CDM-Configuration: Results schema setup
-- Code obtained via:
-- http://127.0.0.1:8080/WebAPI/ddl/results?dialect=postgresql&schema=results&vocabSchema=cdmdatabaseschema&tempSchema=temp&initConceptHierarchy=true
